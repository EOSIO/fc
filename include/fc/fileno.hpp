/**
 * GCC code in Feb 2005 by Richard B. Kreckel
 * Public domain source at https://www.ginac.de/~kreckel/fileno/
 *
 * Clang code in Oct 2016 by Alan Birtles
 * CC-BY-SA source at https://stackoverflow.com/a/39836224
 *
 * Repairs to make it build and to tolerate defective template handling
 * in specific versions of GCC by Jonathan Giszczak, incorporated herein.
 */
